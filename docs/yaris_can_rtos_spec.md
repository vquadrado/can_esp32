...
C++ no **ESP-IDF + FreeRTOS**. Sem Arduino. Dois apps: `firmware/simulator` e `firmware/reader`, código comum em `components/`. Spec do leitor: [firmware/reader/SPEC.md](../firmware/reader/SPEC.md). Spec do simulador: [firmware/simulator/SPEC.md](../firmware/simulator/SPEC.md).
